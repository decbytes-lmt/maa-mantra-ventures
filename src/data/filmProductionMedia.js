...
const modules = import.meta.glob('/src/assets/film production/**/*.{jpg,jpeg,png,webp,gif,bmp,avif,heic,heif,jfif,tif,tiff,mp4,mov,webm,JPG,JPEG,PNG,WEBP,GIF,BMP,AVIF,HEIC,HEIF,JFIF,TIF,TIFF,MP4,MOV,WEBM}', {
  eager: true,
  import: 'default',
});
